...
public class MftfSelectorReferenceProvider extends PsiReferenceProvider {
    ...
    public PsiReference[] getReferencesByElement(@NotNull PsiElement element, @NotNull ProcessingContext context) {
        ...
        for (VirtualFile virtualFile: containingFiles) {
            ...
            Logger.getInstance("pizzatime").info("sectionName: " + sectionName);
            Logger.getInstance("pizzatime").info("elementName: " + elementName);
        ...
        Logger.getInstance("pizzatime").info("PsiElements.size for " + modifiedValue + ": " + psiElements.size());
